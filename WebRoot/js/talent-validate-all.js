...
//        span.name = validateSpanNameOfErrorMsg;
//        _addClassName_(span, classNameOfValidateErrorMsg);
//        _addClassName_(this.element, classNameOfValidateErrorInput);
//        this.element.
	}
});
...
BaseValidator.prototype=
{
    ...
    add:function()
    {
        ...
        for (var i = 0; i < arguments.length; i++)
        {
            if (this.checkUnique(arguments[i]))
            {
                ...
                var es = document.getElementsByName(arguments[i]);
                if (es) {
    ...
    addId:function(){
        ...
        for (var i = 0; i < arguments.length; i++)
        {
            ...
            if (this.checkUnique(theName) && this.checkUniqueForId(arguments[i]))
            {
                this.fieldArray[i + startIndex] = new Field("", null, arguments[i]);
